# Generated by Django 3.1.14 on 2023-05-09 14:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('username', models.CharField(max_length=150, unique=True, validators=[django.core.validators.RegexValidator(message='Неверный формат', regex='^[a-zA-z0-9]')])),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('requested_by', 'requested_to'), name='unique_friend_request'),
        ),
    ]
